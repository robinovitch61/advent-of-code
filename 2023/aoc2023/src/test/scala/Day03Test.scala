...
class Day03Test extends AnyFlatSpec with Matchers {
  "getNumber" should "work" in {
    Day03.getNumber("...123...", 3) shouldEqual Some(RangeNum(123, 3, 6))
    Day03.getNumber("...123...", 4) shouldEqual Some(RangeNum(123, 3, 6))
    Day03.getNumber("...123...", 5) shouldEqual Some(RangeNum(123, 3, 6))
    Day03.getNumber("...123...", 6) shouldEqual None
  }
  it should "work at edges" in {
    Day03.getNumber("467..", 2) shouldEqual Some(RangeNum(467, 0, 3))
    Day03.getNumber("..467", 2) shouldEqual Some(RangeNum(467, 2, 5))
  }
  it should "handle negative nums" in {
    Day03.getNumber(".-467", 2) shouldEqual Some(RangeNum(467, 2, 5))
    Day03.getNumber(".-...", 1) shouldEqual None
    Day03.getNumber("..46-", 2) shouldEqual Some(RangeNum(46, 2, 4))
  }
